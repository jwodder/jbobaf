...
Lojban/ - directory containing the Lojban Perl modules
 ...
 Lojban/Vlatai.pm - morphology routines
...
the {gismu} list is assigned to `$gimste' on line 41, and the {cmavo} list's
path is assigned to `$mahoste' on line 42.  The paths should be absolute paths
...
available on lojban.org do), set `$dosyste' to 1 on line 43.
